...
There are 2 main Classes that are responsible for detection of a Free/Occupied parking position using two collection "parking_areas" and "parking_positions":
1. Parking Model.
2. 2. Parking Position Detector.
